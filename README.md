...
<div align="center">
  <figure style="display: inline-block; width: 30%; margin-right: 10px; text-align: center;">
    <img src="images/merge_example.png" alt="merge_example" style="width: 25%;">
    <figcaption style="text-align: center;">Merge</figcaption>
  </figure>
  <figure style="display: inline-block; width: 30%; margin-right: 10px; text-align: center;">
    <img src="images/switch_example.png" alt="switch_example" style="width: 25%;">
    <figcaption style="text-align: center;">Switch</figcaption>
  </figure>
  <figure style="display: inline-block; width: 30%; text-align: center;">
    <img src="images/composite_example.png" alt="composite_example" style="width: 25%;">
