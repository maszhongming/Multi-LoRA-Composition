...
<div style="display: flex; justify-content: center; align-items: flex-start; flex-wrap: wrap;">
  <div style="flex: 0 1 30%; margin-right: 10px; text-align: center;">
    <img src="images/merge_example.png" alt="merge_example" style="width: 100%; max-width: 100%;">
    <figcaption>Merge</figcaption>
  </div>
  <div style="flex: 0 1 30%; margin-right: 10px; text-align: center;">
    <img src="images/switch_example.png" alt="switch_example" style="width: 100%; max-width: 100%;">
    <figcaption>Switch</figcaption>
  </div>
  <div style="flex: 0 1 30%; text-align: center;">
    <img src="images/composite_example.png" alt="composite_example" style="width: 100%; max-width: 100%;">
