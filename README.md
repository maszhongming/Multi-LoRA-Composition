...
<div align="center">
  <div style="display: inline-block; width: 20%; margin-right: 50px;">
    <img src="images/merge_example.png" alt="merge_example" style="width: 20%;">
  </div>
  <div style="display: inline-block; width: 20%; margin-right: 50px;">
    <img src="images/switch_example.png" alt="switch_example" style="width: 20%;">
  </div>
  <div style="display: inline-block; width: 20%;">
    <img src="images/composite_example.png" alt="composite_example" style="width: 20%;">
  </div>
</div>
