...
<p align="center">
    <img src="images/intro_fig.pdf" width="666" alt="intro_case">
</p>
...
<p align="center">
  <figure style="display: inline-block; width: 30%; margin-right: 10px; text-align: center;">
    <img src="images/merge_example.png" alt="merge_example" width="30%">
    <figcaption>Merge</figcaption>
  </figure>
  <figure style="display: inline-block; width: 30%; margin-right: 10px; text-align: center;">
    <img src="images/switch_example.png" alt="switch_example" width="30%">
    <figcaption>Switch</figcaption>
  </figure>
  <figure style="display: inline-block; width: 30%; text-align: center;">
    <img src="images/composite_example.png" alt="composite_example.png" width="30%">
